...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/Users/momeppkt/.config/opencode/context/`) so they're project-specific and git-committed.
...
Local location: /Users/momeppkt/.config/opencode/context/
...
If local `/Users/momeppkt/.config/opencode/context/project-intelligence/` already exists:
...
Will copy to:   /Users/momeppkt/.config/opencode/context/project-intelligence/
...
**Actions on approval:**
1. Create `/Users/momeppkt/.config/opencode/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to /Users/momeppkt/.config/opencode/context/project-intelligence/
...
**Permission denied:**
```
Error: Cannot write to /Users/momeppkt/.config/opencode/context/project-intelligence/
...
- Context path resolution: `/Users/momeppkt/.config/opencode/context/core/system/context-paths.md`
