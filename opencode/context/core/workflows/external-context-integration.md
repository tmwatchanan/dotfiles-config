...
- Answer is in `/Users/momeppkt/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/momeppkt/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/momeppkt/.config/opencode/context/core/workflows/task-delegation-basics.md`
