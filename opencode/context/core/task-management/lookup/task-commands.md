...
```bash
npx ts-node /Users/momeppkt/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/momeppkt/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
