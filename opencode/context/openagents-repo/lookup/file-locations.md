...
| **Context files** | `/Users/momeppkt/.config/opencode/context/` |
...
| **New context** | `/Users/momeppkt/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/momeppkt/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/momeppkt/.config/opencode/context/core/standards/code-quality.md`
- `/Users/momeppkt/.config/opencode/context/ui/web/react-patterns.md`
- `/Users/momeppkt/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/momeppkt/.config/opencode/context/{category}/

# All context
find /Users/momeppkt/.config/opencode/context -name "*.md"
```
