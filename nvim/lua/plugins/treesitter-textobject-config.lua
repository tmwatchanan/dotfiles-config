...
mini_ai_module.opts = function()
    ...
    return {
        ...
        custom_textobjects = {
            ...
            ['='] = spec_treesitter({
                a = { '@assignment.lhs', '@keyword_argument_name', '@field_name.inner', '@assignment_variable_id', '@typed_default_parameter_name_type', '@assignment_left_type', '@key' },
                i = { '@assignment.rhs', '@keyword_argument_value', '@field_value', '@typed_default_parameter_value', '@value' },
            }),
